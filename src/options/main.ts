...
const OPTIONS_COPY = {
  zh: {
    ...
    asrEndpointHelp: '用于实时全双工音频转录的 WebSocket 地址，默认使用 StepFun ASR Stream，并走系统代理。',
  ...
  en: {
    ...
    asrEndpointHelp: 'WebSocket URL for realtime full-duplex audio transcription. StepFun ASR Stream is used by default and follows the system proxy.',
    asrEndpointLabel: 'WebSocket',
